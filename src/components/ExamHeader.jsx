function ExamHeader({ currentQuestion, totalQuestions }) {
  return (
    <header className="relative overflow-hidden bg-[linear-gradient(120deg,rgb(27,82,87),rgb(36,109,115)_58%,rgb(54,132,136))] px-12 py-8 text-white shadow-[0_12px_30px_rgba(27,82,87,0.18)] max-[900px]:px-8 max-[900px]:py-7 max-[600px]:px-5 max-[600px]:py-6">
      ...
      <div className="min-w-0">
        ...
        <h1 className="m-0 max-w-3xl text-[clamp(24px,5vw,42px)] font-bold leading-tight tracking-tight text-white max-[600px]:break-words">লোডিং ও আনলোডিং পরীক্ষা</h1>
        <p className="mt-2 font-sans text-xs text-teal-100/80">নিরাপদ কাজের পদ্ধতি ও সরঞ্জাম ব্যবহারের মূল্যায়ন</p>
      </div>
      <div className="shrink-0 rounded-2xl border border-white/20 bg-black/10 px-4 py-3 text-center shadow-inner max-[600px]:rounded-xl max-[600px]:px-3 max-[600px]:py-2" aria-label={`প্রশ্ন ${currentQuestion + 1}, মোট ${totalQuestions}`}>
